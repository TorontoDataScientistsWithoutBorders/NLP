...
from assignment2_sol.utils.general_utils import logged_loop, get_minibatches
from assignment2_sol.q2_parser_transitions import PartialParse, minibatch_parse
...
class Config(object):
    ...
    data_path = './assignment2_sol/data'
    train_file = 'train.conll'
    dev_file = 'dev.conll'
    test_file = 'test.conll'
    embedding_file = './assignment2_sol/data/en-cw.txt'
...
class Parser(object):
    ...
    def parse(self, dataset, eval_batch_size=5000):
        ...
        #print("ABOUT TO TAKE MINIBATCH")
        dependencies = minibatch_parse(sentences, model, eval_batch_size)
        #print("FINISHED MINIBATCH")
